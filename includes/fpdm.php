...
//							$this->set_field_value("tooltip",$name,$value);
		...
		*
		**/
		function Output($name='', $dest='', $pdf_data='',$pdf_output=''){
		//-----------------------------------
			...
			if($this->support == "pdftk") {
				...
				$tmp_file=false;
				$pdf_file=$name; //resolve_path(fix_path(dirname(__FILE__).'/'.$this->pdf_source));      //string: full pathname to the input pdf , a form file
				...
				if($this->fdf_source) { //FDF file provided
					...
					$fdf_filename="fields".rnunid().".fdf";
					$fdf_file=fix_path(FPDM_CACHE).$fdf_filename;
					$tmp_file=true;
				...
				$ret=pdftk($pdf_file,$fdf_file,array("security"=>$security,"output_modes"=>$output_modes),$pdf_output);
